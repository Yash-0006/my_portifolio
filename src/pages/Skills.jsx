...
const Skills = () => {
  return (
    <div className='flex justify-center items-center h-auto min-h-[85vh] sm:min-h-[100vh] py-10'>
      <div className='flex flex-col justify-center items-center lg:items-start w-5/6 lg:w-8/12 m-4 lg:m-10 px-5 lg:px-20 py-10 rounded-2xl shadow-2xl'>
        ...
        <div className='flex flex-wrap items-center gap-5 mb-6'>
          <p className='hidden lg:block text-4xl font-semibold'>Frontend : </p>
        ...
        <div className='flex flex-wrap justify-center items-center gap-5 mb-2'>
          <p className='hidden lg:block text-4xl font-semibold'>Backend : </p>
        ...
        <div className='flex flex-wrap items-center gap-5 mb-10'>
          <p className='hidden lg:block text-4xl font-semibold'>Database : </p>
        ...
        <div className='flex flex-wrap items-center gap-5 mb-6'>
          <p className='hidden lg:block text-4xl font-semibold'>Languages : </p>
