...
const Hero = () => {
  return (
    <div className='relative flex items-center justify-center h-[90vh] max-w-6xl'>
        ...
        <div className='absolute z-10 flex flex-col gap-10 md:ml-30 lg:ml-30  items-start sm:flex-row justify-center sm:items-center'>
